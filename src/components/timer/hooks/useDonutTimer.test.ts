...
describe('useDonutTimer', () => {
  ...
  describe('progress calculation', () => {
    it('should calculate progress correctly based on timeLeft and duration', () => {
      ...
      const { result } = renderHook(() => useDonutTimer(duration, timeLeft, 'medium'));
      
      // Progress = (timeLeft / duration) * circumference
      const expectedProgress = (timeLeft / duration) * result.current.circumference;
    ...
    it('should update progress when timeLeft changes', () => {
      ...
      const expectedNewProgress = (newTimeLeft / duration) * initialCircumference;
  ...
  describe('edge cases', () => {
    ...
    it('should handle full progress when timeLeft equals duration', () => {
      ...
      const { result } = renderHook(() => useDonutTimer(duration, duration, 'medium'));
